...
export class MemberInfoChangeResponse {
  private readonly studentId: number;
  private readonly email: string;
  private readonly name: string;
  private readonly major: Major;

  constructor(studentId: number, email: string, name: string, major: Major) {
    this.studentId = studentId;
    this.email = email;
    this.name = name;
    this.major = major;
  ...
  public static of(member: Member): MemberInfoChangeResponse {
    return new MemberInfoChangeResponse(
      member.getStudentId(),
      member.getEmail(),
      member.getName(),
      member.getMajor()
